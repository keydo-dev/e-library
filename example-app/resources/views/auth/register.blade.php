  ...
  <div class="flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-white border-r border-gray-200 hidden md:block">
      ...
      <nav class="mt-6">
        ...
        <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-2.5 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900">
        ...
        <a href="{{ route('auth.login') }}" class="flex items-center px-4 py-2.5 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900">
          <i class="ri-login-box-line mr-3 text-lg"></i> Login
        </a>
        <a href="{{ route('auth.register') }}" class="flex items-center px-4 py-2.5 text-sm font-medium bg-gray-100 text-gray-900">
          <i class="ri-user-add-line mr-3 text-lg"></i> Register
        </a>
      </nav>
    </aside>
        ...
        <div class="bg-white rounded-lg shadow-md p-8">
          <form action="{{ route('auth.register') }}" method="POST">
            ...
            <div class="mb-6">
              ...
              <div class="relative">
                ...
                <input type="text" id="name" name="name" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent" required>
              </div>
            </div>
            ...
            <div class="mb-6">
              ...
              <div class="relative">
                ...
                <input type="password" id="password_confirmation" name="password_confirmation" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent" required>
              </div>
            </div>
          ...
          <div class="text-center mt-6">
            <p class="text-sm text-gray-600">
              ...
              <a href="{{ route('auth.login') }}" class="font-medium text-emerald-600 hover:text-emerald-800">Sign in</a>
            </p>
          </div>
        </div>
      </div>
